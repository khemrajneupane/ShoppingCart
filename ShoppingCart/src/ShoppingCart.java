...
public class ShoppingCart {
	//private ArrayList<Item> itemList = new ArrayList<Item>();// Throws error: Exception in thread "main" java.util.ConcurrentModificationException.
	...
	public String toString() {
		...
		String message = "";
			for(Item item : itemList) {
				...
				message += item.getProduct().getProductNum()+": "+item.getProduct().getProductName()+", quantity: "
			+item.getQantity()+", unit price: "+twoDecimal.format(priceUnit)+", subtotal: "+twoDecimal.format(total)+"\n";
				grandTotal += total;
		}
			System.out.print("\n=== Shopping cart ===\n");
